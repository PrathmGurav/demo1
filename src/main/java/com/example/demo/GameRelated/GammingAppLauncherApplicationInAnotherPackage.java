...
public class GammingAppLauncherApplicationInAnotherPackage {
...
//	}
	...
	public static void main(String[] args) {
		try (// 1 Launch a Spring context
				var context = new AnnotationConfigApplicationContext(GammingAppLauncherApplicationInAnotherPackage.class);) {
